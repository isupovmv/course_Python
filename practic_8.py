...
#    try:
#        with open(file_to_add, 'r') as new_contacts, open(phonebook, 'a', encoding='utf-8') as file:
...
while True:
    ...
    user_choice = input('2 - Найти контакт\n3 - Добавить контакт\n4 - Изменить контакт\n5 - Удалить контакт\n6 - Просмотреть все контакты\nq - Выйти из приложения\n')
    print()
    #if user_choice == '1':
    #    file_to_add = input('Введите название импортируемого файла: ')
    #    import_data(file_to_add, file)
    if user_choice == '2':
        contact_list = read_file_to_dict(file)
